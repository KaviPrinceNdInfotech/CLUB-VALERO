...
namespace CLUB_VALERO_DB.Entities
{
    public class Member
    {
       ...
       public string ApptType { get; set; }
        ...
        public string InstrumentNo { get; set; } /*No Script Field*/

        public string Debit_Credit_Card { get; set; }

        public string QRCode { get; set; }   /*No Script Field*/

        //EMI Plan///
        public string EMIOpted { get; set; }
        public string EmiAmount { get; set; }       
        public Nullable<DateTime> EmiStartDate { get; set; }
